...
dependencies to `>= A.B && < A.(B+1)`; the 1.2 release uses `>= 1.2 && < 1.3`. Public
...
- Major: breaking public API or semantic changes, including a new major version of a
  dependency whose types appear in a package's public API.
